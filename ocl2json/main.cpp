...
int main() {
  ...
  for (int i = 0; i < platforms.size(); ++i) {
    ...
    json11::Json platform_json = json11::Json::object({
                                                          {PlatformInfoToString(CL_PLATFORM_PROFILE),
                                                           platform_profile.data()},
                                                          {PlatformInfoToString(CL_PLATFORM_VERSION),
                                                           platform_version.data()},
                                                          {PlatformInfoToString(CL_PLATFORM_NAME),
                                                           platform_name.data()},
                                                          {PlatformInfoToString(CL_PLATFORM_VENDOR),
                                                           platform_vendor.data()},
                                                          {PlatformInfoToString(CL_PLATFORM_EXTENSIONS),
                                                           platform_extensions.data()},
                                                      });
    ...
    for (int j = 0; j < devices.size(); ++j) {
      ...
      json11::Json device_json = json11::Json::object({
                                                          {DeviceInfoToString(CL_DEVICE_TYPE),
                                                           DeviceTypeToString(device_type)},
                                                          {DeviceInfoToString(CL_DEVICE_VENDOR_ID),
                                                           static_cast<int>(device_vendor_id)},
                                                          {DeviceInfoToString(CL_DEVICE_MAX_COMPUTE_UNITS),
                                                           static_cast<int>(device_max_compute_units)},
                                                          {DeviceInfoToString(CL_DEVICE_MAX_WORK_ITEM_DIMENSIONS),
                                                           static_cast<int>(device_max_work_item_dimensions)},
                                                          {DeviceInfoToString(CL_DEVICE_MAX_WORK_ITEM_SIZES),
                                                           std::vector<int>(device_max_work_item_sizes.begin(),
                                                                            device_max_work_item_sizes.end())},
                                                          {DeviceInfoToString(CL_DEVICE_MAX_WORK_GROUP_SIZE),
                                                           static_cast<int>(device_max_work_group_size)},
                                                          {DeviceInfoToString(CL_DEVICE_PREFERRED_VECTOR_WIDTH_CHAR),
                                                           static_cast<int>(device_preferred_vector_width_char)},
                                                          {DeviceInfoToString(CL_DEVICE_PREFERRED_VECTOR_WIDTH_SHORT),
                                                           static_cast<int>(device_preferred_vector_width_short)},
                                                          {DeviceInfoToString(CL_DEVICE_PREFERRED_VECTOR_WIDTH_INT),
                                                           static_cast<int>(device_preferred_vector_width_int)},
                                                          {DeviceInfoToString(CL_DEVICE_PREFERRED_VECTOR_WIDTH_LONG),
                                                           static_cast<int>(device_preferred_vector_width_long)},
                                                          {DeviceInfoToString(CL_DEVICE_PREFERRED_VECTOR_WIDTH_FLOAT),
                                                           static_cast<int>(device_preferred_vector_width_float)},
                                                          {DeviceInfoToString(CL_DEVICE_PREFERRED_VECTOR_WIDTH_DOUBLE),
                                                           static_cast<int>(device_preferred_vector_width_double)},
                                                          {DeviceInfoToString(CL_DEVICE_PREFERRED_VECTOR_WIDTH_HALF),
                                                           static_cast<int>(device_preferred_vector_width_half)},
                                                          {DeviceInfoToString(CL_DEVICE_NATIVE_VECTOR_WIDTH_CHAR),
                                                           static_cast<int>(device_native_vector_width_char)},
                                                          {DeviceInfoToString(CL_DEVICE_NATIVE_VECTOR_WIDTH_SHORT),
                                                           static_cast<int>(device_native_vector_width_short)},
                                                          {DeviceInfoToString(CL_DEVICE_NATIVE_VECTOR_WIDTH_INT),
                                                           static_cast<int>(device_native_vector_width_int)},
                                                          {DeviceInfoToString(CL_DEVICE_NATIVE_VECTOR_WIDTH_LONG),
                                                           static_cast<int>(device_native_vector_width_long)},
                                                          {DeviceInfoToString(CL_DEVICE_NATIVE_VECTOR_WIDTH_FLOAT),
                                                           static_cast<int>(device_native_vector_width_float)},
                                                          {DeviceInfoToString(CL_DEVICE_NATIVE_VECTOR_WIDTH_DOUBLE),
                                                           static_cast<int>(device_native_vector_width_double)},
                                                          {DeviceInfoToString(CL_DEVICE_NATIVE_VECTOR_WIDTH_HALF),
                                                           static_cast<int>(device_native_vector_width_half)},
                                                          {DeviceInfoToString(CL_DEVICE_MAX_CLOCK_FREQUENCY),
                                                           static_cast<int>(device_max_clock_frequency)},
                                                          {DeviceInfoToString(CL_DEVICE_ADDRESS_BITS),
                                                           static_cast<int>(device_address_bits)},
                                                          {DeviceInfoToString(CL_DEVICE_MAX_MEM_ALLOC_SIZE),
                                                           static_cast<int>(device_max_mem_alloc_size)},
                                                          {DeviceInfoToString(CL_DEVICE_IMAGE_SUPPORT),
                                                           static_cast<bool>(device_image_support)},
                                                          {DeviceInfoToString(CL_DEVICE_MAX_READ_IMAGE_ARGS),
                                                           static_cast<int>(device_max_read_image_args)},
                                                          {DeviceInfoToString(CL_DEVICE_MAX_WRITE_IMAGE_ARGS),
                                                           static_cast<int>(device_max_write_image_args)},
                                                          {DeviceInfoToString(CL_DEVICE_IMAGE2D_MAX_WIDTH),
                                                           static_cast<int>(device_image2d_max_width)},
                                                          {DeviceInfoToString(CL_DEVICE_IMAGE2D_MAX_HEIGHT),
                                                           static_cast<int>(device_image2d_max_height)},
                                                          {DeviceInfoToString(CL_DEVICE_IMAGE3D_MAX_WIDTH),
                                                           static_cast<int>(device_image3d_max_width)},
                                                          {DeviceInfoToString(CL_DEVICE_IMAGE3D_MAX_HEIGHT),
                                                           static_cast<int>(device_image3d_max_height)},
                                                          {DeviceInfoToString(CL_DEVICE_IMAGE3D_MAX_DEPTH),
                                                           static_cast<int>(device_image3d_max_depth)},
                                                          {DeviceInfoToString(CL_DEVICE_MAX_SAMPLERS),
                                                           static_cast<int>(device_max_samplers)},
                                                          {DeviceInfoToString(CL_DEVICE_MAX_PARAMETER_SIZE),
                                                           static_cast<int>(device_max_parameter_size)},
                                                          {DeviceInfoToString(CL_DEVICE_MEM_BASE_ADDR_ALIGN),
                                                           static_cast<int>(device_mem_base_addr_align)},
                                                          {DeviceInfoToString(CL_DEVICE_MIN_DATA_TYPE_ALIGN_SIZE),
                                                           static_cast<int>(device_min_data_type_align)},
                                                          {DeviceInfoToString(CL_DEVICE_SINGLE_FP_CONFIG),
                                                           DeviceFPConfigToString(device_single_fp_config)},
                                                          {DeviceInfoToString(CL_DEVICE_GLOBAL_MEM_CACHE_TYPE),
                                                           DeviceMemCacheTypeToString(device_global_mem_cache_type)},
                                                          {DeviceInfoToString(CL_DEVICE_GLOBAL_MEM_CACHELINE_SIZE),
                                                           static_cast<int>(device_global_mem_cacheline_size)},
                                                          {DeviceInfoToString(CL_DEVICE_GLOBAL_MEM_CACHE_SIZE),
                                                           static_cast<int>(device_global_mem_cache_size)},
                                                          {DeviceInfoToString(CL_DEVICE_GLOBAL_MEM_SIZE),
                                                           static_cast<int>(device_global_mem_size)},
                                                          {DeviceInfoToString(CL_DEVICE_MAX_CONSTANT_BUFFER_SIZE),
                                                           static_cast<int>(device_max_constant_buffer_size)},
                                                          {DeviceInfoToString(CL_DEVICE_MAX_CONSTANT_ARGS),
                                                           static_cast<int>(device_max_constant_args)},
                                                          {DeviceInfoToString(CL_DEVICE_LOCAL_MEM_TYPE),
                                                           DeviceLocalMemTypeToString(device_local_mem_type)},
                                                          {DeviceInfoToString(CL_DEVICE_LOCAL_MEM_SIZE),
                                                           static_cast<int>(device_local_mem_size)},
                                                          {DeviceInfoToString(CL_DEVICE_ERROR_CORRECTION_SUPPORT),
                                                           static_cast<bool>(device_error_correction_support)},
                                                          {DeviceInfoToString(CL_DEVICE_PROFILING_TIMER_RESOLUTION),
                                                           static_cast<int>(device_profiling_timer_resolution)},
                                                          {DeviceInfoToString(CL_DEVICE_ENDIAN_LITTLE),
                                                           static_cast<bool>(device_endian_little)},
                                                          {DeviceInfoToString(CL_DEVICE_AVAILABLE),
                                                           static_cast<bool>(device_available)},
                                                          {DeviceInfoToString(CL_DEVICE_COMPILER_AVAILABLE),
                                                           static_cast<bool>(device_compiler_available)},
                                                          {DeviceInfoToString(CL_DEVICE_EXECUTION_CAPABILITIES),
                                                           DeviceExecCapabilitiesToString(device_execution_capabilities)},
                                                          {DeviceInfoToString(CL_DEVICE_QUEUE_PROPERTIES),
                                                           CommandQueuePropertiesToString(device_queue_properties)},
                                                          ...
                                                          {DeviceInfoToString(CL_DRIVER_VERSION),
                                                           driver_version.data()},
                                                          {DeviceInfoToString(CL_DEVICE_PROFILE),
                                                           device_profile.data()},
                                                          {DeviceInfoToString(CL_DEVICE_VERSION),
                                                           device_version.data()},
                                                          {DeviceInfoToString(CL_DEVICE_OPENCL_C_VERSION),
                                                           device_opencl_c_version.data()},
                                                          {DeviceInfoToString(CL_DEVICE_EXTENSIONS),
