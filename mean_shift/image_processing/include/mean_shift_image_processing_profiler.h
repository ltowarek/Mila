#ifndef MILA_MEAN_SHIFT_IMAGE_PROCESSING_PROFILER_H_
#define MILA_MEAN_SHIFT_IMAGE_PROCESSING_PROFILER_H_
...
#endif  // MILA_MEAN_SHIFT_IMAGE_PROCESSING_PROFILER_H_
