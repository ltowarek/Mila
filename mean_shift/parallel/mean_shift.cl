...
kernel void MeanShift(constant float4 *actual_points, constant float4 *original_points, const int number_of_points, const float bandwidth, global float4 *shifted_points, global float *distances) {
