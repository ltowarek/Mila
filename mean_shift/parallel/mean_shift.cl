...
kernel void MeanShift(global float4 *actual_points, global float4 *original_points, int number_of_points, float bandwidth, global float4 *shifted_points, global float *distances) {
